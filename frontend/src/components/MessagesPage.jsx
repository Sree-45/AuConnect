...
const MessagesPage = () => {
  ...
  }, [selectedConversation, loggedInUsername, messages.length]);
  ...
  const handleSendMessage = async (e) => {
    ...
    if (!newMessage.trim() || !selectedConversation || !loggedInUsername) return;
  ...
  useEffect(() => {
    ...
    // This effect should only run when the selectedConversation changes
              ...
              <>
                      ...
                      <React.Fragment key={message.id}>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              {new Date(message.timestamp).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                              {isOwn && <span style={styles.readStatus}>✓</span>}
                            </div>
                          </div>
                        </div>
                      </React.Fragment>
                ...
                <form style={styles.inputArea} onSubmit={handleSendMessage}>
                  ...
                  <button 
                    ...
                    style={{
                      ...styles.sendButton,
                      backgroundColor: newMessage.trim() ? '#1E40AF' : '#E5E7EB',
